##############################################################################################################
#                     BUILD BAYESIAN NETWORK USING CLIMATIC DATA                                                                    #
##############################################################################################################

# buildCBN.R

#' @title Build a discrete Bayesian Network using climate data.
#' @description Can be used to downscale discrete data to local scales by means of Bayesian Networks.
